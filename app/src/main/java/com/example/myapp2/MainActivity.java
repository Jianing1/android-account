...
import com.example.myapp2.activity.MyActivity;
import com.example.myapp2.activity.RecordActivity;
import com.example.myapp2.activity.SearchActivity;
import com.example.myapp2.adapter.AccountAdapter;
import com.example.myapp2.db.AccountBean;
import com.example.myapp2.db.DBManager;
import com.example.myapp2.utils.BudgetDialog;
import com.example.myapp2.utils.MoreDialog;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.main_btn_more:
                ...
                break;
            case R.id.btn_my:
                Intent it2 = new Intent(this, MyActivity.class);  //跳转界面
                startActivity(it2);
                break;
